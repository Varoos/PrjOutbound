    ...
    public class WarehouseController : Controller
    {
        ...
        public ActionResult MasterPosting(int CompanyId, string SessionId, string Name, string Code)
        {
            ...
            try
            {
                ...
                if (AccessToken == "")
                {
                    ...
                    objreg.SetLog("Warehouse.log", "Invalid Token");
                    //FConvert.LogFile("Warehouse.log", DateTime.Now.ToString() + " : Invalid Token");
                    var sMessage = "Token Should not be Empty";
                    objreg.SetLog("Warehouse.log", sMessage);
                    //FConvert.LogFile("Warehouse.log", DateTime.Now.ToString() + " : " + sMessage);
                ...
                if (isGroup == 0)
                {
                    ...
                    using (WebClient client = new WebClient())
                    {
                        ...
                        objreg.SetLog("Warehouse.log", " PostingURL :" + PostingURL);
                        ...
                        if (lng.ResponseStatus.IsSuccess == true)
                        {
                            ...
                            if (res == 1)
                            {
                                objreg.SetLog("Warehouse.log", "Data posted / updated to mobile app device");
                                //FConvert.LogFile("Warehouse.log", DateTime.Now.ToString() + "Data posted / updated to mobile app device");
                            }
                        ...
                        else
                        {
                            ...
                            {
                                objreg.SetLog("Warehouse.log", "Error Message for Warehouse Master:" + item);
                                //FConvert.LogFile("Warehouse.log", DateTime.Now.ToString() + "Error Message for Outlet Master:" + item);
                            ...
                            if (FailedListCount > 0)
                            {
                                ...
                                {
                                    objreg.SetLog("Warehouse.log", "FailedList Message for Warehouse Master with Master Id:" + item.FldId + " and Code:" + item.FldCode);
                                    //FConvert.LogFile("Warehouse.log", DateTime.Now.ToString() + "FailedList Message for Outlet Master with Master Id:" + item.FldId + " and Code:" + item.FldCode);
            ...
            catch (Exception e)
            {
                errors1 = e.Message;
                Message = e.Message;
                objreg.SetLog("Warehouse.log", " Error :" + errors1);
                //FConvert.LogFile("Warehouse.log", DateTime.Now.ToString() + " Error :" + errors1);
            }
            return Json(new { Message = Message }, JsonRequestBehavior.AllowGet);
        }
        ...
        public ActionResult MasterDelete(int companyId, string Name, string Code)
        {
            ...
            try
            {
                ...
                {
                    client.Headers.Add("Content-Type", "application/json");
                    objreg.SetLog("Warehouse.log", "Delete PostingURL :" + PostingURL);
                    var arrResponse = client.UploadString(PostingURL, sContent);
                    ...
                    if (lng.ResponseStatus.IsSuccess == true)
                    {
                        ...
                        objreg.SetLog("Warehouse.log", "Delete Response" + Message);
                        //FConvert.LogFile("Warehouse.log", DateTime.Now.ToString() + "Delete Response" + Message);
                    }
                    else
                    {
                        objreg.SetLog("Warehouse.log", "Delete Failed Response" + lng.ResponseStatus.StatusMsg);
                        //FConvert.LogFile("Warehouse.log", DateTime.Now.ToString() + "Delete Failed Response" + lng.ResponseStatus.StatusMsg);
                        ...
                        foreach (var item in ErrorMessagesList)
                        {
                            Message = item;
                            objreg.SetLog("Warehouse.log", "Error Message for Warehouse Master:" + item);
                            //FConvert.LogFile("Warehouse.log", DateTime.Now.ToString() + "Error Message for Employee Master:" + item);
                        }
        ...
        public string GetAccessToken()
        {
            ...
            {
                client.Headers.Add("Content-Type", "application/json");
                objreg.SetLog("Warehouse.log", " AccessTokenURL :" + AccessTokenURL);
